...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <p class="mb-4">Menambahkan data program baru.</p>
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            ...
            <div class="card-body px-lg-5">
                <form action="/dashboard/program/{{ $program->slug }}" enctype="multipart/form-data" method="post">
                    @csrf
                    @method('patch')
                    <div class="row mb-3">
                        <div class="col-md-3 col-sm-12">
                            <p class="my-0">Judul Program</p>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9 col-sm-12 custom-file">
                            <input class="custom-file-input" type="file" id="file_cover" name="file_cover"
                                accept=".png,.jpg">
                            <label class="custom-file-label" for="file_cover">{{ $program->photo }}</label>
                            @error('file_cover')
                                <div class="small text-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9 col-sm-12 custom-file">
                            <input class="custom-file-input" type="file" id="file_poster" name="file_poster"
                                accept=".png,.jpg">
                            <label class="custom-file-label" for="file_poster">{{ $program->poster }}</label>
                            @error('file_poster')
                                <div class="small text-danger">
                                    {{ $message }}
                                </div>
